...
export declare class Client extends AbstractClient {
     ...
     * 绑定成员访问授权策略和组织管理员子账号
     */
    BindOrganizationPolicySubAccount(req: BindOrganizationPolicySubAccountRequest, cb?: (error: string, rep: BindOrganizationPolicySubAccountResponse) => void): Promise<BindOrganizationPolicySubAccountResponse>;
    /**
     * 查询用户组中的用户列表
     */
     ...
     * 解绑成员访问授权策略和组织管理员子账号
     */
    CancelOrganizationPolicySubAccount(req: CancelOrganizationPolicySubAccountRequest, cb?: (error: string, rep: CancelOrganizationPolicySubAccountResponse) => void): Promise<CancelOrganizationPolicySubAccountResponse>;
    /**
     * 接受加入共享单元邀请。
     */
     ...
     * 修改组织成员访问策略
     */
    UpdateOrganizationMembersPolicy(req: UpdateOrganizationMembersPolicyRequest, cb?: (error: string, rep: UpdateOrganizationMembersPolicyResponse) => void): Promise<UpdateOrganizationMembersPolicyResponse>;
    /**
     * 创建用户组
     */
